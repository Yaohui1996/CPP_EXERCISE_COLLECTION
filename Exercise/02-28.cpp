...
int main() {
  ...
  std::cout << "编译器抛出: error: uninitialized 'const cp' [-fpermissive]"
            << std::endl;
  // (b) int *p1, *const p2;
  ...
  std::cout << "编译器抛出: error: uninitialized 'const ic' [-fpermissive]"
            << std::endl;
  // (d) const int *const p3;
  std::cout << "(d) const int *const p3;" << std::endl;
  std::cout << "不合法, 未初始化const指针p3" << std::endl;
  std::cout << "编译器抛出: error: uninitialized 'const p3' [-fpermissive]"
            << std::endl;
  // (e) const int *p;
  const int *p;
