...
%     \item 若需插入排序优于归并排序，则需$n$满足不等式：$8n^2 \le 64n\lg{n}$。解得：$2 \leq n \leq 43$。
%     \item 原问题等价于求解满足不等式：$100n^2 \le 2^n$的最小的$n$。解得：$n \geq 15$。
% \end{enumerate}
...
\begin{enumerate}
    ...
    \item {
          ...
          \lstinputlisting{./other-codes/exercise_2_1_2.py}
          }
    \item {
          线性查找的算法描述为：
          \begin{codebox}
          ...
          \lstinputlisting{./other-codes/exercise_2_1_3.py}
