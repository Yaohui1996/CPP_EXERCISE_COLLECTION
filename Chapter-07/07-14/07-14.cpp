...
struct Sales_data {
  ...
  // units_sold(n), revenue(n * p) {}//声明并定义构造函数
...
int main() {
  ...
  cout << obj1.isbn() << " " << obj1.units_sold << " " << obj1.revenue << " "
       << obj1.avg_price() << endl;
  cout << obj2.isbn() << " " << obj2.units_sold << " " << obj2.revenue << " "
       << obj2.avg_price() << endl;
  cout << obj3.isbn() << " " << obj3.units_sold << " " << obj3.revenue << " "
       << obj3.avg_price() << endl;
  cout << obj4.isbn() << " " << obj4.units_sold << " " << obj4.revenue << " "
       << obj4.avg_price() << endl;
  cout << obj5.isbn() << " " << obj5.units_sold << " " << obj5.revenue << " "
       << obj5.avg_price() << endl;
  return 0;
}
