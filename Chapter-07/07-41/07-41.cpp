...
public:
  ...
  Sales_data(const string &s, unsigned n, double p)
      : bookNo(s), units_sold(n), revenue(n * p) {} // 声明并定义构造函数
  Sales_data(const string &s) : Sales_data(s, 0, 0.0) {} // 声明并定义构造函数
  ...
  unsigned getUnitsSold() { return this->units_sold; }

  unsigned getRevenue() { return this->revenue; }
...
int main() {
  ...
  cout << obj1.isbn() << " " << obj1.getUnitsSold() << " " << obj1.getRevenue()
       << " " << obj1.avg_price() << endl;
  cout << obj2.isbn() << " " << obj2.getUnitsSold() << " " << obj2.getRevenue()
       << " " << obj2.avg_price() << endl;
  cout << obj3.isbn() << " " << obj3.getUnitsSold() << " " << obj3.getRevenue()
       << " " << obj3.avg_price() << endl;
  cout << obj4.isbn() << " " << obj4.getUnitsSold() << " " << obj4.getRevenue()
       << " " << obj4.avg_price() << endl;
  return 0;
}
