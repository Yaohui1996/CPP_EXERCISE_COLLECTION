...
Emloyee::Emloyee(const std::string &first_name, const std::string &last_name,
...
//* get
const std::string &Emloyee::get_first_name() const { return first_name_; }
const std::string &Emloyee::get_last_name() const { return last_name_; }
int32_t Emloyee::get_monthly_salary() const { return monthly_salary_; }