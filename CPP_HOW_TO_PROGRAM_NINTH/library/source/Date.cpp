...
Date::Date(const int32_t month, const int32_t day, const int32_t year) : month_(month), day_(day), year_(year)
{
}
//* set
...
void Date::set_day(const int32_t day)
{
    day_ = day;
}
void Date::set_year(const int32_t year)
{
    year_ = year;
}
//* get
